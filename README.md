...
With the entire pipeline implemented, we open ourselves up many possibilities such as:
...
Both of which will help streamline the process of training future lidar computer vision models.
